...
//        when(worldMock.getObstacles()).thenReturn(List.of(new SquareObstacle(1, 1, 2, "obstacle")));
//        when(worldMock.getLakes()).thenReturn(List.of(new SquareObstacle(2, 2, 3, "lake")));
//        when(worldMock.getBottomLessPits()).thenReturn(List.of(new SquareObstacle(3, 3, 4, "pit")));
//
//            // Perform test
